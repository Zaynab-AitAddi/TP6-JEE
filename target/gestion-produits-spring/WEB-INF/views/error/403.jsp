    ...
    <div class="error-container">
        ...
        <div class="error-details">
            <p>
                ...
                Votre rôle utilisateur n'autorise pas l'accès à cette page. Si vous pensez que c'est une erreur, 
        ...
        <div class="error-actions">
            ...
            <a href="${pageContext.request.contextPath}/logout" class="secondary">🚪 Déconnexion</a>
        </div>
    </div>
